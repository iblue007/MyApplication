 ...
 * 
 */
public class okhttpStringUtils {
	...
	public static String findString(String search, String start, String end) {
		...
		int start_pos = okhttpStringUtils.isEmpty(start) ? 0 : search.indexOf(start);
		if (start_pos > -1) {
			int end_pos = okhttpStringUtils.isEmpty(end) ? -1 : search.indexOf(end,
					start_pos + start_len);
			if (end_pos > -1)
