...
public class HttpRequestParam {
    ...
    public static void headers(Context context, HashMap map) {
        try {
            String clientGuid = getUUId(context);
            String clientInfo = NetLibUtil.getVersionName(context) + ",Android," + Build.VERSION.RELEASE;
            map.put("Connection", "close");
            map.put("client-info", clientInfo);
            map.put("client-guid", clientGuid);
         ...
         //   map.put("token", SharePreferenceUtil.getParam(SharePreferenceUtil.token,""));


            long timeStamp = System.currentTimeMillis();
           // String key = ApiUrlManager.signKey;
           // String signMd5 = MD5Util.md5Encrypt32Lower("client-guid=" + clientGuid + "&client-info=" + clientInfo + "&timestamp=" + timeStamp + key);
          //  map.put("sign", signMd5);
            map.put("timestamp", timeStamp + "");
          //  LogUtils.e("======", "======sign0:" + "client-guid=" + clientGuid + "&client-info=" + clientInfo + "&timestamp=" + timeStamp + key);
          //  LogUtils.e("======", "======sign1:" + signMd5);
